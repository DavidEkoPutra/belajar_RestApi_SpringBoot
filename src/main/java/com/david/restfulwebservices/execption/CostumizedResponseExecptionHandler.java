...
import com.david.restfulwebservices.user.UserNotFoundException;
...
@ControllerAdvice
@RestController
public class CostumizedResponseExecptionHandler extends ResponseEntityExceptionHandler {

    @ExceptionHandler(Exception.class)
    public final ResponseEntity<Object> handleAllException(Exception ex, WebRequest request) throws Exception{
        ExpectionResponse expectionResponse = new ExpectionResponse(new Date(), ex.getMessage(), request.getDescription(false));
